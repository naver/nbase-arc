...
/* Default Redis Commands */
  ...
  {"del", multi_key_int_reply_command, -2, "w", 0, 1, -1, 1, 0, 0},
  {"exists", multi_key_int_reply_command, -2, "r", 0, 1, -1, 1, 0, 0},
  {"setbit", single_key_command, 4, "wm", 0, 1, 1, 1, 0, 0},
  {"getbit", single_key_command, 3, "r", 0, 1, 1, 1, 0, 0},
  {"bitfield", single_key_command, -2, "wm", 0, 1, 1, 1, 0, 0},
  ...
  {"zremrangebylex", single_key_command, 4, "w", 0, 1, 1, 1, 0, 0},
  ...
  {"zrangebylex", single_key_command, -4, "r", 0, 1, 1, 1, 0, 0},
  {"zrevrangebylex", single_key_command, -4, "r", 0, 1, 1, 1, 0, 0},
  {"zcount", single_key_command, 4, "r", 0, 1, 1, 1, 0, 0},
  {"zlexcount", single_key_command, 4, "r", 0, 1, 1, 1, 0, 0},
  ...
  {"hstrlen", single_key_command, 3, "r", 0, 1, 1, 1, 0, 0},
  ...
  {"cluster", NULL, -2, "Na", 0, 0, 0, 0, 0, 0},
  {"restore", single_key_command, 4, "awm", 0, 1, 1, 1, 0, 0},
  {"restore-asking", NULL, -4, "Nwm", 0, 1, 1, 1, 0, 0},
  {"migrate", NULL, 6, "Naw", 0, 0, 0, 0, 0, 0},
  {"asking", NULL, 1, "N", 0, 0, 0, 0, 0, 0},
  {"readonly", NULL, 1, "N", 0, 0, 0, 0, 0, 0},
  {"readwrite", NULL, 1, "N", 0, 0, 0, 0, 0, 0},
  ...
  {"wait", NULL, 3, "Ns", 0, 0, 0, 0, 0, 0},
  {"command", NULL, 0, "Nlt", 0, 0, 0, 0, 0, 0},
  {"geoadd", single_key_command, -5, "wm", 0, 1, 1, 1, 0, 0},
  {"georadius", single_key_command, -6, "w", 0, 1, 1, 1, 0, 0},
  {"georadiusbymember", single_key_command, -5, "w", 0, 1, 1, 1, 0, 0},
  {"geohash", single_key_command, -2, "r", 0, 1, 1, 1, 0, 0},
  {"geopos", single_key_command, -2, "r", 0, 1, 1, 1, 0, 0},
  ...
  {"host:", NULL, -1, "Nlt", 0, 0, 0, 0, 0, 0},
  {"latency", NULL, -2, "Naslt", 0, 0, 0, 0, 0, 0},
/* Gateway Commands */
