...
public class HBState {
    ...
    public synchronized HBState setZkData(String state, long stateTimestamp, int version) {
    ...
    public synchronized HBState setLastState(String lastState) {
    ...
    public synchronized HBState setLastStateTimestamp(long lastStateTimestamp) {
    ...
    public synchronized HBState setSubmitMyOpinion(boolean submitMyOpinion) {
