...
public class DefaultBoundSessionOfHashListOperationsTest {

    @Autowired
    private StringRedisClusterTemplate redis;
    private BoundSessionOfHashListOperations<String, String, String> ops;
    private List<String> values = new ArrayList<String>();

    @Before
    public void before() {
        ops = redis.boundSessionOfHashListOps("s001", "members");
    ...
    @After
    public void after() {
        redis.opsForSessionOfHashList().del("s001");
    }

    @Test
    public void get() {
        List<String> list = ops.get("k001");
    ...
    public void multiGet() {
        ...
        Map<String, List<String>> map = ops.multiGet(keys);
