...
public class DefaultSessionOfHashListOperationsTest {

    @Autowired
    private StringRedisClusterTemplate redis;
    private SessionOfHashListOperations<String, String, String> ops;
    private List<String> values = new ArrayList<String>();

    @Before
    public void before() {
        ops = redis.opsForSessionOfHashList();
    ...
    @Test
    public void get() {
        List<String> list = ops.get("s001", "f001", "k001");
    ...
    public void multiGet() {
        ...
        Map<String, List<String>> map = ops.multiGet("s001", "f001", keys);
