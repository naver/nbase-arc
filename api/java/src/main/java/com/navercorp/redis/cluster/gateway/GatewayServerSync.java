 ...
 * @author jaehong.kim
 */
class GatewayServerSync implements GatewayServerImpl {
    private static final String CLIENT_SYNC_KEY_PREFIX = "##@@*25419530;CLIENT_SYNC;^##@&&*$#;620278919530;";

    /**
     * The log.
     */
    private final Logger log = LoggerFactory.getLogger(GatewayServerSync.class);
    ...
    public GatewayServerSync(GatewayAddress address) {
        this(address, DEFAULT_POOL_CONFIG, DEFAULT_TIMEOUT_MILLISEC, null);
    }

    public GatewayServerSync(GatewayAddress address, RedisClusterPoolConfig poolConfig, int timeoutMillisec,
            String keyspace) {
