...
/**
 * The Interface SessionOfHashListOperations.
 *
 ...
 * @author jaehong.kim
 */
public interface SessionOfHashListOperations<H, HK, HV> {
     ...
     * @return the list
     */
    List<HV> get(H key, HK field, HK name);
     ...
     * @return the map
     */
    Map<HK, List<HV>> multiGet(H key, HK field, Collection<HK> names);
     ...
     * @return the long
     */
    Long set(H key, HK field, HK name, HV values);
     ...
     * @return the long
     */
    Long set(H key, HK field, HK name, HV values, long timeout, TimeUnit unit);
