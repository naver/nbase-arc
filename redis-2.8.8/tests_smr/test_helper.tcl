...
source tests_smr/support/redis.tcl
source tests_smr/support/server.tcl
source tests_smr/support/tmpfile.tcl
source tests_smr/support/test.tcl
source tests_smr/support/util.tcl
...
set ::smr_replicator "../smr/replicator/smr-replicator"
...
proc cleanup {} {
    ...
    flush stdout
    catch {exec rm -rf {*}[glob tests_smr/tmp/redis.conf.*]}
    catch {exec rm -rf {*}[glob tests_smr/tmp/server.*]}
    if {!$::quiet} {puts "OK"}
}
